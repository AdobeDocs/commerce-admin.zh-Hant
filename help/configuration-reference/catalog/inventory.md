...
>[!NOTE]
>
>若要設定並支援&#x200B;**非同步佇列管理員**，您必須使用命令列。 這可能需要開發人員協助。 請參閱&#x200B;_設定指南_&#x200B;中的[開始訊息佇列消費者](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cli/start-message-queues)。
