...
>[!NOTE]
>
>適用於Adobe Commerce和Magento Open Source的[!DNL Inventory Management]提供您管理產品詳細目錄的工具。 擁有單一商店到多個倉庫、商店、取貨地點、卸貨託運人等等的商家，可以使用這些功能來維護銷售數量，並處理出貨以完成訂單。 如需這些功能以及如何使用這些功能來管理多個位置中的庫存的詳細資訊，請參閱[_[!DNL Inventory Management]使用手冊&#x200B;_](/help/inventory-management/introduction.md)。
...
>[!NOTE]
>
>若要設定並支援&#x200B;**非同步佇列管理員**，您必須使用命令列。 這可能需要開發人員協助。 請參閱&#x200B;_設定指南_&#x200B;中的[開始訊息佇列消費者](https://experienceleague.adobe.com/zh-hant/docs/commerce-operations/configuration-guide/cli/start-message-queues)。
