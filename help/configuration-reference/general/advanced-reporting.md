...
description: 檢閱Commerce管理員的[!UICONTROL General] &gt； [!UICONTROL Advanced Reporting]頁面上的組態設定。
...
_[!DNL Advanced Reporting]_&#x200B;是雲端型服務，由[Adobe Commerce Intelligence](https://experienceleague.adobe.com/zh-hant/docs/commerce-business-intelligence/mbi/getting-started){:target="_blank"}提供技術支援。 如需詳細資訊，請參閱_&#x200B;快速入門手冊&#x200B;_中的[進階報告](/help/getting-started/business-intelligence.md#advanced-reporting){:target="_blank"}。
