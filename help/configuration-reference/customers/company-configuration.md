...
| [!UICONTROL Default "Company Status Change to Active 1' Email] | 存放區檢視 | 當公司的狀態從變更時所使用的電子郵件範本 _未決核准_ 至 _作用中_. 預設範本： `Company Status Active 1` |
| [!UICONTROL Default 'Company Status Change to Active 2' Email] | 存放區檢視 | 公司狀態從變更時預設使用的電子郵件範本 _已拒絕_ 或 _已封鎖_ 至 _作用中_. 預設範本： `Company Status Active 2` |
| [!UICONTROL Default 'Company Status Change to Rejected' Email] | 存放區檢視 | 公司狀態變更為時預設使用的電子郵件範本 _已拒絕_. 預設範本： `Company Status Rejected` |
...
![公司評價](./assets/company-email-options-company-credit.png)<!-- zoom -->
...
| [!UICONTROL Reimbursed Email Template] | 存放區檢視 | 預設使用的電子郵件範本，當 [補助](../../b2b/credit-company.md#apply-a-payment-to-a-company-account) 受公司讚譽。 此電子郵件會傳送給公司管理員。 預設範本： `Credit Reimbursed` |
