...
description: 檢閱上的組態設定 [!UICONTROL Advanced] &gt； [!UICONTROL Admin] Commerce管理員的頁面。
...
| [!UICONTROL Font] | 全域 | 決定用於顯示驗證碼的字型。 若要新增您自己的字型，請將字型檔案放在與Commerce執行個體相同的目錄中，然後將宣告新增至config.xml檔案，網址為 `app/code/Magento/Captcha/etc` 預設字型：` LinLibertine` |
