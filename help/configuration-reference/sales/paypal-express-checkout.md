...
![PayPal Express簽出必要設定](./assets/paypal-express-required-settings.png)<!-- zoom -->
...
| [!UICONTROL Home Page] | 網站 | 決定位置與大小 [!DNL PayPal Credit] 首頁上的橫幅。 選項： <br/>**顯示**  — 顯示[!DNL PayPal Credit] 橫幅出現在商店首頁。 選項： `Yes` / `No` <br/>**位置**  — 決定 [!DNL PayPal Credit] 首頁上的橫幅。 選項：頁首（中央） /側欄（右側） <br/>**大小**  — 決定 [!DNL PayPal Credit] 首頁上的橫幅。 選項： `190 x 100` / `234 x 60` / `300 x 50` / `468 x 60` / `728 x 90` /` 800 x 66` |
...
| [!UICONTROL Sort Order] | 存放區檢視 | 在結帳期間與其他付款方式一起列出時，決定PayPal Express結帳順序的數字。 輸入 `0` ，位於清單頂端。 |
...
| 欄位 | [範圍](../../getting-started/websites-stores-views.md#scope-settings) | 說明 |
|--- |--- |--- |
| [!UICONTROL Display on Shopping Cart] | 存放區檢視 | 決定PayPal Express結帳是否顯示為購物車中的付款選項。 選項： `Yes` （建議PayPal） / `No` |
