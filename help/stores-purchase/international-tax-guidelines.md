...
| 稅金運送？ | 是 |
| 套用折扣 | 稅前折扣，價格包含稅金。 |
| 註解 | 讓B2B商家提供更簡單的VAT supply chain考量事項。 資料列上的稅捐計算也有效；不過，請洽詢您的稅捐管轄區。 設定假設商家在supply chain，且售出的商品由其他廠商用於增值稅退稅等。 此定義可讓您輕鬆依料號識別稅捐，以加快產生返利的時間。 <br/><br/>**_注意:_**&#x200B;某些管轄區需要Commerce目前不支援的不同舍入策略，而且並非所有管轄區都允許專案或列層級稅捐。 |
