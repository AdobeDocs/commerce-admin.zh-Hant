...
[PayPal Payments Pro](https://developer.paypal.com/docs/paypal-payments-pro/)將商家帳戶與付款閘道的所有優點整合在一起，讓您能夠建立自己的完全自訂的結帳體驗。 PayPal Express Checkout會自動透過PayPal Payments Pro啟用，因此您可以利用超過1.1億位作用中的PayPal使用者。
...
- [PayPal商家帳戶](https://www.paypal.com/webapps/mpp/how-to-sell-online) （已啟用直接付款）
...
1. 展開![區段的](../assets/icon-display-expand.png)擴充選擇器&#x200B;**[!UICONTROL Payments Pro and Express Checkout]**。
...
1. 展開![區段的](../assets/icon-display-expand.png)擴充選擇器&#x200B;**[!UICONTROL Basic Settings - PayPal Payments Pro]**。
