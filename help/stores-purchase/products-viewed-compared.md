...
1. 展開![區段的](../assets/icon-display-expand.png)擴充選擇器&#x200B;**[!UICONTROL Recently Viewed/Compared Products]**。
   ...
   如需這些組態設定的詳細說明，請參閱[組態參考指南](../configuration-reference/catalog/catalog.md#recently-viewedcompared-products)中的&#x200B;_最近檢視/比較的產品_。
