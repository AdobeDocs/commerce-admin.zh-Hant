...
- **FedEx** — 請連絡[FedEx Web Integration Services](https://www.fedex.com/en-us/api/get-support.html)，瞭解您帳戶的標籤列印需求。
- **USPS** — 請參閱託運人支援中心底下的[Web Tools API入口網站](https://www.usps.com/business/web-tools-apis/#ssc)，瞭解如何設定標籤列印認證。
- **UPS** — 請連絡[UPS](https://www.ups.com/us/en/support/contact-us.page)，確認您的帳戶支援運送標籤。 若要產生出貨標籤，您必須使用UPS XML選項。
- **DHL** — 請連絡[DHL電子商務解決方案](https://www.dhl.com/us-en/home/our-divisions/ecommerce-solutions.html)，瞭解您帳戶的標籤列印需求。
...
1. 選取&#x200B;**[!UICONTROL DHL Type]**&#x200B;作為`DHL REST`或`DHL XML`。

1. 根據&#x200B;**[!UICONTROL DHL Type]**&#x200B;選取專案，確認下列認證已完成：
...
| [!UICONTROL Length, Width, Height] | （選用）套件維度僅用於自訂套件。 您可以將度量單位指定為英吋或公分。<br/><br/>**[!UICONTROL Not Required]**：出貨承運商不會將任何交貨確認傳送至商店。<br/><br/>**[!UICONTROL No Signature]**：出貨承運商會傳送沒有收件者簽章的交貨確認至商店。<br/><br/>**[!UICONTROL Signature Required]**：出貨承運商會取得收件者的簽章，並提供商店的列印復本。<br/><br/>**[!UICONTROL Direct]**： （僅限FedEx） FedEx會取得交貨地址上某人的簽章。 如果沒有人可簽署此封裝，則電信業者會在其他時間嘗試傳送此封裝。<br/><br/>**[!UICONTROL Indirect]**： （僅限FedEx住宅傳送） FedEx會取得傳送位址上某人（可能是鄰居或建築經理）的簽章。 收件者可留下已簽署的FedEx門牌以授權在沒有任何人出席的情況下留下包裹以供簽署。<br/><br/>**[!UICONTROL Contents]**： （僅限USPS）選取下列其中一個包裹說明： <br/> — 禮物<br/> — 檔案<br/> — 商業範例<br/> — 退回的商品<br/> — 商品<br/> — 其他&#x200B;<br/><br/>**[!UICONTROL Explanation]**： （僅限USPS）包裹內容的詳細說明。<br/><br/>**[!UICONTROL Adult Required]**：運送業者取得成人收件者的簽章，並提供商店的列印復本。 |
...
| [!UICONTROL Signature] | 定義傳遞確認。 選項：<br/><br/>**[!UICONTROL Not Required]**：沒有傳送傳遞確認函給您。<br/><br/>**[!UICONTROL No Signature]**：沒有收件者簽章的傳遞確認函已傳送給您。<br/><br/>**[!UICONTROL Signature Required]**：出貨承運商取得收件者的簽章，並提供您列印的復本。<br/><br/>**[!UICONTROL Adult Required]**：出貨承運商取得成人收件者的簽章，並提供您列印的復本。<br/><br/>**[!UICONTROL Direct (FedEx only)]**：FedEx從傳遞地址的人取得簽章，如果沒有人可簽章封裝，則重新嘗試傳遞。<br/><br/>**[!UICONTROL Indirect (FedEx only)]**： FedEx以下三種方式之一取得簽章：<br/>(1)從傳遞地址的人取得；<br/>(2)從鄰居的樓宇經理(3)收件人可留下已簽署的FedEx Door標籤，授權他人不在場的情況下釋放包。 <br/>僅適用於住宅傳送。 選項可能因不同的送貨方法而略有不同。 如需最新資訊，請參閱運送業者的資源。 |
