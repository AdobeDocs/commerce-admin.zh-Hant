...
但是，想要簡化Adobe Commerce和Adobe商業產品登入流程的使用者可以設定其Adobe ID登入商店管理員： [在&#x200B;*Commerce的IMS整合指南*&#x200B;中設定Commerce與Adobe ID的管理員整合](https://experienceleague.adobe.com/en/docs/commerce-admin/start/admin/ims/adobe-ims-config)。
