...
>[!NOTE]
>
>Adobe Commerce已移除原生&#x200B;_Magento Social_ Facebook整合，不再支援此擴充功能。 移至[Commerce Marketplace](https://marketplace.magento.com/catalogsearch/result/?q=Facebook){:target="_blank"}，尋找Facebook整合的替代擴充功能。

### 步驟1. 取得按鈕程式碼

1. 在Meta開發人員網站上，前往[按鈕設定](https://developers.facebook.com/docs/plugins/like-button)頁面。
...
1. 視您的內容工具而定，將程式碼片段新增至區塊內容：
   ...
   - 使用[!DNL Page Builder]時，請新增[HTML程式碼](../page-builder/html-code.md)區塊至階段，並貼上您從Facebook網站複製的程式碼片段。 否則，請將程式碼片段貼到&#x200B;**[!UICONTROL Content]**&#x200B;方塊中。
...
讀取RSS摘要所需的軟體稱為摘要讀取器，可讓使用者訂閱標題、部落格、播客等。 Google Reader是眾多可線上免費使用的摘要閱讀器之一。
