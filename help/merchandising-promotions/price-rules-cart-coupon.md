...
1. 展開&#x200B;**[!UICONTROL Manage Coupon Codes]**&#x200B;區段，然後按一下&#x200B;**[!UICONTROL Add Coupon Code]**。
   ...
   ![自訂優惠券代碼](./assets/custom-coupon-codes.png){width="600" zoomable="yes"}

1. 在&#x200B;**[!UICONTROL Add Custom Coupon]**&#x200B;對話方塊中，輸入您要用於購物車價格規則的優惠券代碼，然後按一下&#x200B;**[!UICONTROL Save]**。

   ![新增優惠券代碼](./assets/add-custom-coupon.png){width="600" zoomable="yes"}

1. 按一下&#x200B;**[!UICONTROL Save]**&#x200B;以更新購物車價格規則。

若要刪除自訂優惠券代碼，請在格線中選取要刪除的代碼，然後從&#x200B;**[!UICONTROL Actions]**&#x200B;選取器中選取&#x200B;**[!UICONTROL Delete]**。
...
![編輯優惠券代碼](./assets/edit-coupon-code.png){width="600" zoomable="yes"}
...
1. 展開&#x200B;**[!UICONTROL Manage Coupon Codes]**&#x200B;區段，然後按一下&#x200B;**[!UICONTROL Import]**。
   ...
   >[!NOTE]
   >
   >**[!UICONTROL Import]**&#x200B;按鈕可用於儲存的購物車價格規則，其中&#x200B;**[!UICONTROL Coupon]**&#x200B;設定為`Specific Coupon`且&#x200B;**[!UICONTROL Use Auto Generation]**&#x200B;已關閉。

1. 在&#x200B;**[!UICONTROL Import Coupons]**&#x200B;對話方塊中，按一下&#x200B;**[!UICONTROL Choose File]**&#x200B;並選取包含您要匯入的優惠券代碼的CSV檔案。
   ...
   選取檔案後，對話方塊會顯示&#x200B;**[!UICONTROL Preview]**，其中顯示準備匯入的程式碼數目，以及檔案中第一個程式碼的範例。

   ![匯入優惠券對話方塊](./assets/import-custom-coupons.png){width="600" zoomable="yes"}

1. 按一下&#x200B;**[!UICONTROL Import]**。 此對話方塊會顯示已排入佇列的程式碼數目摘要，以及任何已略過的現有程式碼清單。
