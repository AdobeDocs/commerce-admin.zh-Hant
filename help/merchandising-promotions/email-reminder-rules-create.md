...
1. 在左側的面板中，選擇&#x200B;**[!UICONTROL Conditions]**。
   ...
   >
   >**_新_**&#x200B;放棄的購物車&#x200B;**_之後_** **_期間結束後，同一客戶的_**&#x200B;未重新觸發&#x200B;_[!UICONTROL Repeat Schedule]_相同的電子郵件提醒。
   >
...
1. 在&#x200B;_預設標題和說明_&#x200B;區段中，執行下列動作：
   ...
   - 在&#x200B;_[!UICONTROL Titles and Descriptions Per Store View]_區段中，輸入&#x200B;**[!UICONTROL Rule Title]**預設存放區檢視&#x200B;**[!UICONTROL Description]**的_&#x200B;和&#x200B;_。 針對多個商店檢視，輸入每個商店檢視的適當標題和說明。
...
1. [!BADGE 僅限SaaS]{type=Positive url="https://experienceleague.adobe.com/en/docs/commerce/user-guides/product-solutions" tooltip="僅適用於Adobe Commerce as a Cloud Service和Adobe Commerce Optimizer專案（Adobe管理的SaaS基礎結構）。"}如果您使用[!DNL Adobe Commerce as a Cloud Service]，可以選取[核取方塊來啟用](#rule-repeatability)規則重複性[!UICONTROL Rule Repeatability]。
   ...
   >[!IMPORTANT]
   >
   >規則重複選項是實驗性功能，預設為停用。  如需啟用選項的詳細資訊，請參閱[規則重複性](#rule-repeatabilty)。
...
>[!IMPORTANT]
>
>這是實驗性功能，預設不會啟用。 若要啟用此功能，請聯絡您的Adobe Commerce客戶成功經理或建立支援票證。 在未來版本中，將提供給所有Adobe Commerce as a Cloud Service客戶使用。
...
您已捨棄購物車規則，該規則在1天後觸發，並在3和5天後重新觸發。 使用者放棄購物車，1天後，他們收到放棄的購物車電子郵件提醒。 2天後，使用者決定完成購買。 購物車不再放棄。 10天後，使用者放棄包含不同專案的新購物車。

- 如果&#x200B;**[!UICONTROL Rule Repeatability]**&#x200B;已啟用，使用者會收到新的放棄購物車電子郵件提醒。
- 如果&#x200B;**[!UICONTROL Rule Repeatability]**&#x200B;已停用，使用者&#x200B;**不會**&#x200B;收到任何其他捨棄的購物車電子郵件提醒。
