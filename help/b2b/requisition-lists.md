...
使用請購單清單可節省購買經常訂購產品的時間，因為會直接從清單將料號新增至購物車。 購買者可以維護多個清單，專注於不同廠商、購買者、團隊、行銷活動的產品，或簡化其工作流程的任何其他產品。 登入的使用者可以使用請購單清單功能。
...
與公司帳戶關聯的登入採購員，可以從其帳戶儀表板建立請購單清單。

1. 在其帳戶的側邊欄中，選擇&#x200B;**[!UICONTROL My Requisition Lists]**。

1. 在&#x200B;_[!UICONTROL Requisition Lists]_&#x200B;頁面上，按一下&#x200B;**[!UICONTROL Create New Requisition List]**。
...
與公司帳戶關聯的登入採購員，可以從產品頁面建立請購單清單。 此方法提供建立清單和新增產品的簡單捷徑。

1. 在產品詳細資料頁面中，購買者按一下&#x200B;**[!UICONTROL Add to Requisition List]**。
...
1. 在其帳戶儀表板的側邊欄中，購買者選擇&#x200B;**[!UICONTROL My Orders]**。
...
從可轉讓的報價單中，購買者可以使用[!UICONTROL Move to Requisition List]選項，將產品從報價單移至現有的請購單清單。 如果沒有請購單清單，則無法使用[!UICONTROL Move to Requisition List]選項。

1. 在其帳戶儀表板的側邊欄中，購買者選取&#x200B;**[!UICONTROL My Quotes]**。

1. 在清單中尋找並存取所需的報價。

1. 在[!UICONTROL Items Quoted]索引標籤中，選取要移動的產品。

1. 使用產品條列專案[!UICONTROL Select]欄中的[!UICONTROL Actions]下拉式清單，選擇&#x200B;**[!UICONTROL Move to Requisition list]**。

1. 選取所選料號的請購單清單。

1. 按一下&#x200B;**[!UICONTROL Move item to Requisition List]**。

如需有關B2B引數的詳細資訊，請參閱[我的引號](account-dashboard-my-quotes.md)主題。
...
1. 在請購單清單中，按一下&#x200B;**[!UICONTROL View]**&#x200B;動作&#x200B;_欄中的_。
