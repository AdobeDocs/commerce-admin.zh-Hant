...
Commerce使用命令列提供其他重新索引選項。 如需完整的詳細資料和命令選項，請參閱[組態指南](https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/cli/manage-indexers.html#reindex){:target="blank"}中的&#x200B;_重新索引_。
