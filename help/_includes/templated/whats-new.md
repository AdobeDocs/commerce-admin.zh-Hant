...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>已從<a href="https://experienceleague.adobe.com/en/docs/commerce-admin/b2b/release-notes#b2b-v152-p5">B2B 1.5.2-p5</a>的支援版本清單中移除Adobe Commerce 2.4.8-p5。 2.4.8客戶應該改用B2B 1.5.3版。</p>
</td>
      <td>
        技術
      </td>
