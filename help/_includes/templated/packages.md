...
<table>
  ...
  <tr>
    ...
    <td>洋紅色模組</td>
    <td>Zend_Cache後端使用 Redis 且完全支持標記。</td>
  </tr>
  </tbody>
</table>
...
<table>
  ...
  <tr>
    <td>
      <a href="https://github.com/composer/metadata-minifier.git">作曲家/中繼資料-最小化器</a>
    </td>
    <td>圖書館</td>
  ...
  <tr>
    <td>
      <a href="https://github.com/jsonrainbow/json-schema.git">賈斯汀彩虹/JSON-綱要</a>
    </td>
    <td>資料庫</td>
