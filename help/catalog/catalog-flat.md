...
>[!IMPORTANT]
>
>不再建議使用平面型錄作為最佳實務。 據悉，繼續使用此功能會導致效能降低和其他索引問題。 [說明中心](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/slow-performance-slow-and-long-running-crons)提供詳細的說明和解決方案。<br/><br/>受影響的版本包括：<br/> — 雲端基礎結構上的Adobe Commerce、2.3.x和更高版本<br/>- Adobe Commerce （內部部署）、2.3.x和更高版本<br/>- Magento Open Source、2.3.x和更高版本<br/><br/>在任何發行版本中，某些擴充功能僅適用於平面表格，因此如果您停用平面表格，就會產生風險。 如果您知道有些擴充功能使用一般目錄索引子，則將這些值設定為`No`時，您必須注意這項風險。
