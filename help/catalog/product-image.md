...
當您在商店檢視範圍中開啟「影像詳細資料」檢視時，每個欄位(包括&#x200B;**[!UICONTROL Alt Text]**、影像&#x200B;**[!UICONTROL Role]**&#x200B;指派（基底、小圖、縮圖、色票）和&#x200B;**[!UICONTROL Hide from Product Page]**)都會顯示&#x200B;**[!UICONTROL Use Default Value]**&#x200B;核取方塊。 選取此核取方塊可繼承在該欄位預設範圍中設定的值。

![影像詳細資料檢視 — 存放區檢視](./assets/product-image-detail-store-scope.png){width="600" zoomable="yes"}
