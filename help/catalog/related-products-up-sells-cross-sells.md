...
>[!NOTE]
>
>若要依商店檢視顯示或隱藏交叉銷售專案，請參閱購物車中名為[的](../configuration-reference/sales/checkout.md)結帳>購物車&#x200B;_[!UICONTROL Show Cross-sell Items]_選項。 您可能會想要在特定銷售期間或在商店檢視中隱藏A/B測試的交叉銷售。
