...
請參閱&#x200B;[_安裝指南_](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/tutorials/extensions)以瞭解擴充功能安裝程式的詳細資訊。
...
>[!NOTE]
>
> 如需使用者將3d模型新增至產品的一系列示範影片，請參閱&#x200B;_Adobe Commerce影片和教學課程_&#x200B;中的[Commerce適用的AR檢視器](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/catalog/augmented-reality)頁面。
