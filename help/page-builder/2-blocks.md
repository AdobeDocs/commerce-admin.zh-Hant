...
1. 在格線中，尋找您在第一個教學課程中建立的&#x200B;_[!UICONTROL Simple Page]_，並在&#x200B;**[!UICONTROL Edit]**欄中選取_[!UICONTROL Action]_。

1. 展開![展開選取器](../assets/icon-display-expand.png) **[!UICONTROL Content]**&#x200B;區段，然後按一下&#x200B;**[!UICONTROL Edit with Page Builder]**&#x200B;或內容預覽區域內。

1. 在[!DNL Page Builder]下方的&#x200B;_[!UICONTROL Layout]_面板中，將&#x200B;**[!UICONTROL Row]**預留位置拖曳到舞台頂端。
...
在[!DNL Page Builder]下方的&#x200B;_[!UICONTROL Layout]_面板中，將&#x200B;**[!UICONTROL Column]**預留位置拖曳至列。
...
1. 在[!DNL Page Builder]下方的&#x200B;_[!UICONTROL Layout]_面板中，將新的&#x200B;**[!UICONTROL Row]**預留位置拖曳到舞台頂端。
