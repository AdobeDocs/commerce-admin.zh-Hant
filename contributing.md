...
如果您的變更引進新主題、重大更新或需要強調的更正，您可以從提取要求內文直接在[新增功能區段](https://experienceleague.adobe.com/en/docs/commerce-admin/user-guides/home#whats-new)新增簡短說明。
...
例如，搜尋存放庫中的已關閉提取要求，瞭解現有醒目提示的格式設定，並與[新增功能區段](https://experienceleague.adobe.com/en/docs/commerce-admin/user-guides/home#whats-new)進行比較，瞭解它們在檔案中的顯示方式。
